...
const testimonials = [
  {
    ...
    avatar: "/assets/galeria/Oscar.jpeg",
    quote: "Samuel es un profesional excepcional. Su atención al detalle, compromiso con la calidad y capacidad para entregar proyectos complejos.",
    rating: 5,
  ...
  },
  {
    ...
    quote: "Trabajar con Samuel fue una experiencia increíble. No solo tiene habilidades técnicas sobresalientes.",
    rating: 5,
    company: "Inem",
  },
  {
    ...
    avatar: "/assets/galeria/Diana.jpeg",
    quote: "Su capacidad técnica, creatividad y habilidades de comunicación hacen que sea un placer colaborar con él en cualquier proyecto. Samuel no solo escribe código, también propone soluciones innovadoras que agregan valor real al producto.",
    rating: 5,
    company: "Cleverpy",
  },
  {
    ...
    avatar: "/assets/galeria/Andres.jpeg",
    quote: "La colaboración con Samuel fue fluida y productiva. Su comprensión del diseño y la experiencia del usuario, combinada con sus habilidades de desarrollo.",
    rating: 5,
    company: "Ceiba",
  },
];
